					...
					<div class="card-body">
						...
						<div class="app-brand justify-content-center">
							<a href="index.html" class="app-brand-link gap-2">
								...
								<span class="app-brand-text demo text-body fw-bolder">E-perpus</span>
							</a>
						</div>
						<!-- /Logo -->
						<h4 class="mb-2">Mari Eksplor E-Perpus 🚀</h4>
						<p class="mb-4">Buatlah Hari Yang Menyenangkan😊!</p>

						<form id="formAuthentication" class="mb-3" action="<?= base_url('auth/tambah') ?>" method="POST">
							<div class="mb-3">
								<label for="usernamee" class="form-label">Nama</label>
								<input type="text" class="form-control" id="usernamee" name="nama"
									placeholder="Enter your Nama" required />
							</div>
							<div class="mb-3">
							...
							<div class="mb-3">
								<label for="emaill" class="form-label">Alamat</label>
								<input type="text" class="form-control" id="emaill" name="alamat"
									placeholder="Enter your Alamat" required />
							</div>
							<div class="mb-3">
								<input type="hidden" class="form-control"  name="role_user" value="Peminjam"/>
							</div>
