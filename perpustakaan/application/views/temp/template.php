				...
				<ul class="menu-inner py-1">
					...
					<li class="menu-item">
						<a href="<?= base_url('User')  ?>" class="menu-link ">
							...
							<div data-i18n="Layouts">Data Users</div>
						</a>
					</li>
					<?php } ?>
					<li class="menu-item" style="">
						<a href="javascript:void(0);" class="menu-link menu-toggle">
							...
							<div data-i18n="Form Layouts">Buku</div>
						</a>
						<ul class="menu-sub">
							<li class="menu-item">
								<a href="<?= base_url('Buku/kategori')  ?>" class="menu-link">
									<div data-i18n="Vertical Form">Kategori Buku</div>
								</a>
							</li>
							<li class="menu-item">
					...
					<li class="menu-item">
						<a href="<?= base_url('admin/peminjaman')  ?>" class="menu-link ">
							...
							<div data-i18n="Layouts">Data Peminjaman</div>
						</a>
					</li>
					<li class="menu-item">
										...
										<a class="dropdown-item" href="#">
											<div class="d-flex">
												...
												<div class="flex-grow-1">
													...
													<small class="text-muted"><?= $this->session->userdata('role_user') ; ?></small>
												</div>
											</div>
										</a>
									</li>
					...
					<footer class="content-footer footer bg-footer-theme">
						<div
							...
							<div class="mb-2 mb-md-0">
								...
								, made with ❤️ by
								<a href="<?= base_url() ?>" target="_blank" class="footer-link fw-bolder">Yosgiantoro
									S</a>
							</div>
						</div>
					</footer>
